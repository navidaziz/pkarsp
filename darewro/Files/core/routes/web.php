...
Route::namespace('Admin')->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        //Admin Create
        Route::get('all','AdminController@allAdmin')->name('all');
        Route::post('create','AdminController@adminCreate')->name('create');
        Route::post('update/{id}','AdminController@adminUpdate')->name('update');
        Route::post('remove/{id}','AdminController@adminRemove')->name('remove');
