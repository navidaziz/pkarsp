...
class User_m extends MY_Model{
    ...
    public function get_user_list($limit, $offset){
        ...
        $this->db->select ( 'userId, userTitle, userName, userPassword, userEmail, userStatus, gender, cnic, contactNumber, district_id, users.createdDate, users.createdBy, users.lastUpdatedBy, address, district.districtTitle as districtTitle' ); 
        $this->db->from ( 'users' );
