...
class Note_sheet extends Admin_Controller
{
   ...
   public function index()
   {
      ...
      $this->data['title'] = 'New Files';
      $this->data['description'] = 'File after challan entry';
      $this->data['view'] = 'note_sheet/note_sheet_index';
   ...
   public function cases()
   {
      ...
      WHERE bank_challans.status =1
      ";
      $this->data['school_session_challans'] = $this->db->query($query)->result();
      $this->load->view('note_sheet/cases', $this->data);
   }
