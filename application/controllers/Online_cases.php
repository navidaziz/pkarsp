...
class Online_cases extends Admin_Controller
{
   ...
   public function get_new_requests()
   {
      ...
      $this->get_request_list(2, 3, 2, 'Pending Due (Renewals)');
      $this->get_request_list(2, 3, 4, 'Pending Due (Renewal+Upgradation)');
      $this->get_request_list(2, 3, 4, 'Pending Due (New Registration)');
   }
   ...
   public function  change_file_status($schools_id)
   {
      ...
      if ($school_file_status == 10 or $school_file_status == 4) {
