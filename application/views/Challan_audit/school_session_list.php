<div style="border:1px solid #9FC8E8; border-radius: 10px; min-height: 100px;  margin: 5px; padding: 5px; background-color: white;">
    ...
    <form id="form1" action="<?php echo site_url('challan_audit/verified_challans') ?>" method="post">
                ...
                foreach ($school_sessions as $school_session) { ?>
                    ...
                    foreach ($school_session_challans as $school_session_challan) { ?>
                        <tr>
                            ...
                            <th style="text-align: center;"><?php echo $school_session_challan->challan_no; ?></th>
                            <th style="text-align: center;"><?php echo date("d M, Y", strtotime($school_session_challan->challan_date)); ?></th>
                            <td style="text-align: center;"><?php echo number_format($school_session_challan->application_processing_fee, 2); ?></td>
                            <td style="text-align: center;"><?php echo number_format($school_session_challan->renewal_fee, 2); ?></td>
                            <td style="text-align: center;"><?php echo number_format($school_session_challan->inspection_fee, 2); ?></td>
                            <td style="text-align: center;"><?php echo number_format($school_session_challan->upgradation_fee, 2); ?></td>
                            <td style="text-align: center;"><?php echo number_format($school_session_challan->late_fee, 2); ?></td>
                            <td style="text-align: center;"><?php echo number_format($school_session_challan->fine, 2); ?></td>
                            <td style="text-align: center;"><?php echo number_format($school_session_challan->security_fee, 2); ?></td>
                            <td style="text-align: center;"><?php echo number_format($school_session_challan->penalty, 2); ?></td>
                            <td style="text-align: center;"><?php echo number_format($school_session_challan->miscellaneous, 2); ?></td>
                            <th style="text-align: center;"><?php echo number_format($school_session_challan->total_deposit_fee, 2); ?></th>
                            <td style="text-align: center;">
                                <input required type="radio" name="verified[<?php echo $school_session_challan->bank_challan_id; ?>][v]" value="1" /> Verifed
                                <span style="margin-left:20px ;"></span>
                                <input required type="radio" name="verified[<?php echo $school_session_challan->bank_challan_id; ?>][v]" value="0" /> Not Verified
                                <!-- <a href="#" onclick="edit_bank_challan('<?php echo $school_session_challan->bank_challan_id; ?>')">Edit</a> -->
                            </td>
                        </tr>
                    <?php } ?>
