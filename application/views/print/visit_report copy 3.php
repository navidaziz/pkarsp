...
<head>
  <meta charset="utf-8">
  <title>
    CMR ID: <?php echo $mri_report->mri_report_id; ?> - MR No: <?php echo $mri_report->mr_number; ?>
  </title>
...
<body>
  <page size='A4'>
    ...
    <div style="padding-left: 10px; padding-right: 10px; padding-top:0px !important;" contenteditable="false">
      ...
      <table style="width: 100%; margin-top: 3px; margin-bottom: 10px;">
        ...
        <tfoot>
          <tr>
            <td colspan="2">
              <div class="page-footer-space" style="height: 10px !important;">
