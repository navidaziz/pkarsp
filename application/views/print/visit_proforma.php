            ...
            <tr>
                <td>
                    ...
                    <h5 style="text-transform: uppercase;">
                        School Name:_____________________________________________________</h5>
                    <h5> Visit Reason ( _______________________________________________________ )</h5>
            ...
            <tbody>
              ...
              ?>
                            ...
                            <table class="table table_large ">
                                ...
                                <tr>
                                    <td>B.Ed</td>
                                    <td> <span style="margin-left: 5px;"></span>1. Yes <span
                                            style="margin-left: 20px;"></span> 2. No </td>
                                </tr>
                            </table>
              ...
              if ($school->genderOfSchoolTitle == 'Boys') {
                ...
                <table class="table">
                    <tr>
                        ...
                        <td>
                            <strong>Institute Bank Account <span style="margin-left: 10px;"></span> Yes <span
                                    style="margin-left: 10px;"></span> No</strong>
                            <table class="table table_small table-bordered">
                                <tr>
                                    <td>Account Type:</td>
                                    <td>
                            ...
                            <table class="table table_small table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            Good <span style="margin-left: 10px;"></span> Satisfactory <span
                                                style="margin-left: 10px;"></span> Poor
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr id="more_options" style="display: none;">
                                        ...
                                        <td>
                                            Main road <span style="margin-left: 10px;"></span> Walk through the market
                                            <span style="margin-left: 10px;"></span> Narrow street <span
                                                style="margin-left: 10px;"></span> Open field <span
                                                style="margin-left: 10px;"></span> Standing Crops
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <th>Safe assembly points available for <br>(i. Flood ii. Earthquake iii. Fire
                                            iii. Human induce)</th>
                                        <td>
                                            Yes <span style="margin-left: 10px;"></span> No
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            Local <span style="margin-left: 10px;"></span> Outsider <span
                                                style="margin-left: 10px;"></span> Refugees
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <td>
                            <table class="table table-bordered">
                                <tr>
                                    ...
                                    <th rowspan="2" style="width: 200px;">Publisher's textbooks are being taught in each
                                        levels</th>
                  ...
                  foreach ($classes  as $class) { ?>
                                <tr>
                                    ...
                                    <th style="vertical-align: middle; text-align:center"
                                        rowspan="<?php echo count($classes); ?>">
                                        <?php echo $level->levelofInstituteTitle ?></th>
                                    <?php
                        $count++;
                      } ?>
                                    ...
                                    <?php if ($count2 == 1) { ?>
                                    <th style="vertical-align: middle; text-align:center"
                                        rowspan="<?php echo count($classes); ?>"></th>
                                    <?php
                        $count2++;
                      } ?>
                                </tr>
                ...
                ?>
                                <tr>
                                    <th colspan="3" style="text-align:right; height: 30px;">
                                        <h4>Summary</h4>
                                    </th>
                                    ...
                                    <td colspan="2" style="margin: 0px; padding:0px;">
                                        <table class="table table-bordered"
                                            style="margin: 0px !important; border:0px !important;">
                                            <tr>
                                                <th style=" vertical-align:bottom; text-align: center;">
                                                    <br />
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <strong>Toilets <span style="margin-left: 10px;">Yes</span> <span
                                                style="margin-left: 10px;">No</span></strong>
                                        <table class="table table-bordered">
                                            <tbody>
                                    ...
                                    <td colspan="2">
                                        <table class="table table-bordered">
                                            <tbody>
                                                <tr>
                                                    <th>#</th>
                                                    <th colspan="4">HIGH LEVEL ONLY: <span
                                                            style="margin-left: 10px;"></span>Equipments:</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Yes</td>
                                                    <td>No</td>
                                                    <th style="text-align: center;"> (i) *Sufficient <span
                                                            style="margin-left: 10px;"></span> (ii) Deficient</th>
                                                </tr>
                                        ...
                                        <table class="table table-bordered">
                                            <tbody>
                                                <tr>
                                                    <th>#</th>
                                                    <th colspan="4">HIGH Sec. LEVEL ONLY: <span
                                                            style="margin-left: 10px;"></span> Equipments:</th>
                                    ...
                                    <td>
                                        ...
                                        <strong>Library <span style="margin-left: 10px;">Yes</span> <span
                                                style="margin-left: 10px;">No</span></strong>
                                        <table class="table table-bordered">
                                            <tbody>
                                                <tr>
                ...
                <h5>Recommendation <span class="pull-right"> Visit Date: __________________ Time: ___________</span>
                </h5>
                ...
                <div class="box" style="height: 100px;">
                    <small>In case it is not recommended, please provide specific reasons for the
                        non-recommendation.</small>
                </div>
