...
<table class="table table_reg">
  ...
  <tr>
    ...
    <td>
      <?php if ($level_type == 1) { ?> <strong> 20,000 </strong> <?php } ?>
      <?php if ($level_type == 2) { ?> <strong> 40,000 </strong> <?php } ?>
      <?php if ($level_type == 3) { ?> <strong> 60,000 </strong> <?php } ?>
      <?php if ($level_type == 4) { ?> <strong> 60,000 </strong> <?php } ?>
    </td>
    <td>
      <?php if ($level_type == 1) { ?> <strong> 20,000 </strong> <?php } ?>
      <?php if ($level_type == 2) { ?> <strong> 40,000 </strong> <?php } ?>
