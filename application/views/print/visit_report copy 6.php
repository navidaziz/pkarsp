  ...
  <page size='A4'>
    <div class="wrapper">
      ...
      <section class="invoice">
        ...
        <div class="col-md-12">
          ...
          <table class="table table-bordered">
            <tr>
              ...
              <th style="width: 100px;">Land Type</th>
              <td>Ownership</td>
          ...
          <table class="table table_large table-bordered">
            <thead>
              ...
              <tr>
                ...
                <td>Graduation BS 4 Years</td>
                <td></td>
                <td></td>
                <td></td>
              </tr>
              <tr>
                <td>Post Graduation MA / MSc</td>
                <td></td>
                <td></td>
                <td></td>
              </tr>
        ...
        <strong> Head of institute contact detail </strong>

        <table class="table">
          <tbody>
            <tr>
              <td style="width: 10px;"> Name: </td>
              <td> <input type="text" name="principal" value="Muhammad rome" style="width: 100%;" required=""></td>
            </tr>
            <tr>
              <td> CNIC: </td>
              <td> <input maxlength="15" id="principal_cnic" type="text" name="principal_cnic" value="15602-8499794-1" style="width: 100%;" required=""></td>
            </tr>
            <tr>
              <td> Contact: </td>
              <td> <input maxlength="15" id="principal_contact_no" type="text" name="principal_contact_no" value="(0346)-2714574" style="width: 100%;" required=""></td>
            </tr>
          </tbody>
        </table>
