          ...
          <div class="row">
            <?php echo validation_errors(); ?>
                <div class="col-md-offset-1 col-md-9">
                  <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url('module/create');?>">
                    <div class="box-body">
                      <div class="form-group">
                        <label for="title" class="col-sm-2 control-label">Controller Title</label>

                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="controller_title" value="<?php echo set_value('controller_title');?>" id="title" placeholder="Controller Title">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="desc" value="<?php echo set_value('desc');?>" id="desc" placeholder="Controller Description">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="uri" class="col-sm-2 control-label">Controller URL</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="uri" value="<?php echo set_value('uri');?>" id="uri" placeholder="Controller URL">
                        </div>
                      </div>
