                  ...
                  $school = $this->db->query($query)->row(); ?>
                                    ...
                                    function validateForm() {
                                        ...
                                        if (challan_no.length < 6) {
                                            ...
                                            alert(
                                                'There is an error in the stan number. The stan number contains six digits'
                                            );
                                            false;
                                        }
                                    ...
                                    <div class="">
                                        <div class="alert alert-warning">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div>
                                                        Please submit the bank's STAN number and date below after
                                                        depositing the deficient amount.</div>
                                                </div>
                                                <div class="col-md-6" style="direction: rtl;">
                                                    براہ کرم کمی کی رقم جمع کرنے کے بعد نیچے بینک کا STAN نمبر اور تاریخ
                                                    جمع کرائیں۔
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <small><i>"STAN can be found on the upper right corner of bank generated
                                                receipt"</i></small>
                                        <table class="table">
                                            <tr>
                                                <th>Challan For </th>
                                            ...
                                            <form onsubmit="return validateForm();" class="form-horizontal"
                                                method="post" enctype="multipart/form-data" id="role_form"
                                                action="<?php echo base_url('messages/school_message_details/' . $message_info->message_id); ?>">
                                                <input type="hidden" name="school_id"
                                                    value="<?php echo $message_info->school_session_id; ?>" />
                                                <input type="hidden" name="apply_for" value="Deficiency" />

                                                <tr>
                                                    <td>

                                                        <input type="hidden" name="reg_type_id"
                                                            value="<?php echo $school->reg_type_id; ?>" />
                                                        <?php echo @$school->regTypeTitle; ?>

                                                    </td>
                                                    <td><?php echo @$school->sessionYearTitle; ?></td>
                                                    <td><input required name="challan_date" type="date"
                                                            class="form-control" min="2018-01-01"
                                                            max="<?php echo date('Y-m-d'); ?>" />
                                                    </td>
                                                    <td><input required maxlength="6" id="challan_no" name="challan_no"
                                                            type="text" autocomplete="off" class="form-control" />
                                                    </td>
                                                    <td><input style="display: block;" type="submit"
                                                            class="btn btn-info" name="deficiency_challan"
                                                            value="Add Deficient Bank Challan" id="add_form" />
                                                    </td>
                                                </tr>
                                            </form>
                            ...
                            foreach ($session_bank_challans as $session_bank_challan) { ?>
                                    ...
                                    ?></th>
                                                <th>
                                                    ...
                                                    <a
                                                        href="<?php echo site_url('school/remove_bank_challan/' . $schoolId . '/' . $session_bank_challan->bt_id); ?>"><small>
                                                            <i>Remove</i>
                                                        </small></a>
                                                    <?php } ?>
                                                </th>
                                            ...
                                            <tr>
                                                <td colspan="5" style="text-align: center;">
                                                    <div class="alert alert-danger">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div>To reprocess your case, click "Submit Deficiency
                                                                    Online" after entering your deficiency bank challan.
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6" style="direction: rtl;">
                                                                اپنے کیس کو ری پروسیس کرنے کے لیے، اپنا ڈیفیشینسی بینک
                                                                چالان داخل کرنے کے بعد "Submit Deficiency Online" پر کلک
                                                                کریں۔
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <form method="post"
                                                        ...
                                                        <input class="btn btn-danger" type="submit"
                                                            name="deficiency_completed"
                                                            value="Submit Deficiency Online" />
                                                    </form>
                                                </td>
                                            </tr>
                                            <?php } else { ?>
