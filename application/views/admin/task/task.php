                  ...
                  <tbody>
                    ...
                    <?php foreach ($tasks as $task) : ?>
                      <tr>
                        ...
                        <td> <a href="<?php echo base_url('task/edit/');
                                      echo $task->task_id; ?>" class="btn btn-info btn-flat">Edit</a> &nbsp; <a href="<?php echo base_url('task/delete/');
                                                                                                                                                        echo $task->task_id; ?>" class="btn btn-danger btn-flat">Delete</a></td>
                      </tr>
                    <?php endforeach; ?>
                  </tbody>
                </table>
