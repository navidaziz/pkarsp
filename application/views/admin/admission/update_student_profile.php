...
<div class="modal-body">
    <form action="<?php echo site_url(ADMIN_DIR . "admission/update_profile/" . $students[0]->student_id) ?>" method="post" style="text-align: center;">
        ...
        <table class="table">
            ...
            <tr>
                <th>Contact No:</th>
                <td><input required type="text" id="fathermobilenumber" name="father_mobile_number" value="<?php echo $students[0]->father_mobile_number; ?>" /></td>
            </tr>
            ...
            <tr>
                <th>Address:</th>
                <td><input required type="text" name="student_address" value="<?php echo $students[0]->student_address; ?>" required /></td>
            </tr>
            ...
            <tr>
                ...
                <th>Religion:</th>
                <td>
                    <input required type="radio" name="religion" value="Muslim" <?php if ($students[0]->religion == 'Muslim') { ?>checked<?php } ?> />
                    Muslim
                    <span style="margin-left: 20px;"></span>
            ...
            <tr>
                <th>Nationality:</th>
                <td>
                    <input <?php if ($students[0]->nationality == 'Pakistani') { ?>checked<?php } ?> type="radio" id="pak" name="nationality" onclick="$('#othernationality').hide(); $( '#foreign' ).prop( 'checked' , false );" value="Pakistani" required />
                    Pakistani
                    <span style="margin-left: 10px;"></span>

                    <input <?php if ($students[0]->nationality != 'Pakistani') { ?>checked<?php } ?> id="foreign" type="radio" required onclick="$('#othernationality').show(); $( '#pak' ).prop( 'checked' , false ); " /> Foreigner

                    <div <?php if ($students[0]->nationality == 'Pakistani') { ?>style="display: none;" <?php } ?> id="othernationality">
