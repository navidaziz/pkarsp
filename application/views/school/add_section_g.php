          ...
          <div class="row">
            <!-- col-md-offset-1 -->
                <div class="col-md-offset-1 col-md-10">
                  <form class="form-horizontal" method="post" enctype="multipart/form-data" id="role_form" action="<?php echo base_url('school/add_section_g'); ?>/<?php echo $school_id; ?>" onsubmit="return confirm('Have you revised the data you have entered if yes,then click Ok otherwise click cancel button.');" >
