            ...
            if ($session_bank_challans) {
              ...
              <tr>
                <td colspan="5" style="text-align: center;">
                  <?php if ($school->status == 0) { ?>
                    <a href="<?php echo site_url('school/submit_application_online/' . $schoolId . '/' . $school->schoolId) ?>" onclick="return confirm('Are you sure. you want to submit?')" class=" btn btn-primary"> Submit Application Online</a>
                  <?php } else { ?>
                    <a target="new" href="<?php echo site_url('school/print_application/' . $schoolId . '/' . $school->schoolId) ?>" class=" btn btn-success">Print Application</a>
