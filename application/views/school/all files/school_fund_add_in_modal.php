<form id="Form1" method="post" enctype="multipart/form-data" action="<?php echo base_url('school/school_fund_add_process_ajax'); ?>">
	...
	<div class="modal-body">
		...
		<!--   <div class="col-sm-10">-->
		<input type="hidden" value="0" name="addmissionFee" placeholder="Addmission Fees i-e 500, 600, 700 etc" class="form-control" form="Form1" id="addmissionFee" />
		<!--   </div>-->
		<!--</div>-->
		<!--<br />-->
		...
		<!--   <div class="col-sm-10"> -->
		<input type="hidden" value="0" name="securityFund" placeholder="Security Fund i-e 500, 600, 700 etc" class="form-control" form="Form1" id="securityFund" />
		<!--   </div>-->
		<!--</div>-->
		...
		<!--   <div class="col-sm-10"> -->
		<input type="hidden" value="0" name="otherFund" placeholder="Other Fund i-e 500, 600, 700 etc" class="form-control" form="Form1" id="otherFund" />
		<!--   </div>-->
		<!--</div>-->
		...
		$.ajax({
			...
			success: function(data) {
				...
				if (obj.status == true) {
					$('#myModal').modal('show');
					// $('#myModal').modal('hide');
					$('#msg_one').show().html(obj.msg).fadeOut(1000);
