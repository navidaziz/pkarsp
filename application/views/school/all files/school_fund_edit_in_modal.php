<form id="Form1" method="post" enctype="multipart/form-data" action="<?php echo base_url('school/update_fee_info'); ?>">
	...
	<div class="modal-body">
		...
		<!--   <div class="col-sm-10">-->
		<input type="hidden" name="addmissionFee" placeholder="Addmission Fees i-e 500, 600, 700 etc" value="<?php echo $fee_info->addmissionFee ?>" class="form-control" form="Form1" id="addmissionFee" />
		<!--   </div>-->
		<!--</div>-->
		...
		<div class="form-group" style="padding-top:8px;">
			...
			<div class="col-sm-10">
				<input type="text" name="tuitionFee" placeholder="Fees i-e 500, 600, 700 etc" value="<?php echo $fee_info->tuitionFee ?>" class="form-control" form="Form1" id="tuitionFee" />
			</div>
		</div>
		...
		<!--   <div class="col-sm-10"> -->
		<input type="hidden" name="securityFund" placeholder="Security Fund i-e 500, 600, 700 etc" value="<?php echo $fee_info->securityFund ?>" class="form-control" form="Form1" id="securityFund" />
		<!--   </div>-->
		<!--</div>-->
		...
		<!--   <div class="col-sm-10"> -->
		<input type="hidden" name="otherFund" placeholder="Other Fund i-e 500, 600, 700 etc" class="form-control" value="<?php echo $fee_info->otherFund ?>" form="Form1" id="otherFund" />
		<!--   </div>-->
		<!--</div>-->
