<form id="Form1" method="post" enctype="multipart/form-data" action="<?php echo base_url('school/school_enrollement_add_process_ajax'); ?>">
	...
	<div class="modal-body">
		...
		<div class="form-group" style="padding-top:8px;">
			...
			<div class="col-sm-8 col-md-8">
				<?php if (!empty($age_list)) : ?>
					<select required class="form-control select2" name="age_id" form="Form1" style="width: 100%;">
		...
		<div class="form-group" style="padding-top:8px;">
			...
			<div class="col-sm-8 col-md-8">
				<?php if (!empty($class_list)) : ?>
					<select required class="form-control select2" name="class_id" form="Form1" style="width: 100%;">
		...
		<div class="form-group" style="padding-top:8px;">
			...
			<div class="col-sm-8 ">
				<select required class="form-control select2" id="gender" form="Form1" name="gender_id" style="width: 100%;">
		...
		<div class="form-group" style="padding-top:8px;">
			...
			<div class="col-sm-8">
				<input required type="number" name="enrolled" placeholder="No. of students i-e 10, 20, 37 etc" class="form-control" form="Form1" id="enrolled" />
			</div>
		</div>
		<br />
