    ...
    <div class="row page_break_before light-blue">
      ...
      <div class="col-xs-12">
        <h2 class="page-header" style="font-weight: bolder;height:  auto;">
          ...
          <small class="pull-right" style="color:red;font-weight: bolder;"><?php echo @$school->regTypeTitle; ?>
            <?php if ($school->status != 0) { ?>
              <a target="new" href="<?php echo site_url('print_file/school_session_detail/' . $schoolId . '/') ?>" class=" btn btn-success"> <i class="fa fa-print"></i> Print Application</a>
            <?php } ?>
          </small>
        </h2>
      </div>
    ...
    <div class="row page_break_before" style="min-height: 200px;">
      ...
      <div class="col-xs-12  table-responsive">
        <table class="table table-bordered table-striped">
          <tbody>
            <?php if ($school_physical_facilities) { ?>
              <tr>
            ...
            <tr class="append_total_enrolled">
              ...
              ?>
                <td colspan="6" style="text-align: center;">
                  <h1 style="color:red"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i> Section C is missing ! </h1>
                </td>
              <?php } ?>
            </tr>
        ...
        <table class="table table-bordered table-condensed table-striped">
          ...
          <tbody class="small_font" id="fund_tbody">
            ...
            ?>
              ...
              <td colspan="7" id="empty_td_fee" style="text-align: center;">
                <h1 style="color:red"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i> Section E is missing ! </h1>
              </td>
            <?php } ?>
          </tbody>
        </table>
