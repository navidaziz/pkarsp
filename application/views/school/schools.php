                      ...
                      <div class="form-group col-sm-12">
                        ...
                        <form id="myForm" method="post" enctype="multipart/form-data" action="">
                          ...
                          <div style="margin-left:10px;" class="well well-sm" id="selection">Message Send To :
                            ...
                            <input onclick="get_school_active_session()" required="required" type="radio" name="is_deficiency_message" value="1"> Yes
                            <input onclick="$('#deficiency_type').html('')" required="required" type="radio" name="is_deficiency_message" value="0"> No
                            <br />
