...
<?php if ($school_info) {  ?>
    <div class="col-sm-12" style="background-color: #fff;padding-bottom: 50px;">
        ...
        <address>
            ...
            <hr>
            <?php if (!empty($school_info->userName)) : ?>
                <?php echo "<i class='fa fa-user'></i> User Name : <span style='color:darkgreen;font-size:20px;font-weight:bold;'>" . $school_info->userName . "</span>"; ?>
                <br>
            <?php endif; ?>
        ...
        <div>
            Owner Detail
            <br />
            Owner Name: <strong><?php echo $school_info->userTitle; ?></strong> <br />
            Owner CNIC: <strong><?php echo $school_info->cnic; ?></strong><br />
            Owner Contact No: <strong><?php echo $school_info->contactNumber; ?> </strong><br />
        </div>
