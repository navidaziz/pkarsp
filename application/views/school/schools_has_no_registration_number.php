                    ...
                    <tr>
                     ...
                     <td class="text-center">
                       <a style='margin-bottom:5px;'
                        href="#" class="btn btn-primary btn-flat btn-xs" onclick="load_form_in_modal(<?php echo $school->schoolId; ?>, 'Generate Registration Number', 'School/generate_reg_number');">Generate</a>
                        <br>
