      ...
      <div class="box box-primary box-solid">
        ...
        <div class="box-body">
          <div class="row">
            <!-- col-md-offset-1 -->
                <div class="col-md-12">
                  <form class="form-horizontal" method="post" onsubmit="return confirm('Have you revised the form if yes, click Ok otherwise click cancel button.');" enctype="multipart/form-data" id="role_form" action="<?php echo base_url('school/add_section_b');?>">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-sm-4">
                              <select class="form-control select2" id="building_id" name="building_id" required  style="width: 100%;">
...
<form id="Form2" onsubmit="addRecord(event);"></form>
  ...
  <script type="text/javascript">
      function addRecord(e) { 
          ...
          $("select[form*='Form2']").select2({ allowClear: true }); // re-init to show default status
      }
