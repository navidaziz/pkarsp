    ...
    <section class="invoice">
      ...
      <div class="row page_break_before">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i class="fa fa-university"></i> <?php echo @$school->name; ?> &nbsp;&nbsp;&nbsp; <?php if(!empty($school->ppcCode)){ echo "PPC Code".$school->ppcCode; }?>
            <small class="pull-right"><?php echo @$school->regTypeTitle; ?></small>
          </h2>
        </div>
        <!-- /.col -->
      </div>
      ...
      <div class="row invoice-info">
        ...
        <div class="col-sm-4 invoice-col">
          ...
          <?php if(!empty($school->biseRegister)): ?>
          	<?php echo "Bise Register: ".$school->biseRegister; ?>
          	    <br>
          <?php endif; ?>
          <?php if(!empty($school->registrationNumber)): ?>
          	<?php echo "Registeration #: ".$school->registrationNumber; ?>
          	    <br>
          <?php endif; ?>
          ...
          <div class="table-responsive">
            <table class="table">
              <tr>
                ...
                <td><?php if($school_bank->bankAccountName){ echo $school_bank->bankAccountName; } ?></td>
              </tr>
              <tr>
                <th>Account Number:</th>
                <td><?php if($school_bank->bankAccountNumber){ echo $school_bank->bankAccountNumber; } ?></td>
              </tr>
              <tr>
                <th>Branch Code</th>
                <td><?php if($school_bank->bankBranchCode){ echo $school_bank->bankBranchCode; } ?></td>
              </tr>
              <tr>
                <th>Account Title:</th>
                <td><?php if($school_bank->accountTitle){ echo $school_bank->accountTitle; } ?></td>
              </tr>
              <tr>
                <th>Branch Address:</th>
                <td><?php if($school_bank->bankBranchAddress){ echo $school_bank->bankBranchAddress; } ?></td>
              </tr>
...
<?php endif; ?>
    <div class="clearfix"></div>
      <!-- Table row -->
      <div class="row page_break_before">
      	<h3 class="lead text-center">Section-B: Physical Facilities</h3>
        <div class="col-xs-12 table-responsive">
          <table class="table table-bordered">
            ...
            <?php if(!empty($school_physical_facilities->numberOfClassRoom)): ?>
           	...
           	<?php $library_count = count($school_library);?>
           	 <?php if($library_count > 0): ?>
           	 	    <td colspan="2" class="text-center"><strong>Library details</strong></td>
            ...
            <td colspan="2" class="text-center">
                <button type="button" onclick="load_form_in_modal(<?php echo $school->schoolId; ?>, 'Add Book In Library', 'School/add_books_in_library_view');" class="btn btn-flat btn-sm btn-primary no-print"><i class="fa fa-plus"></i> Add Books
                </button>
            </td>
           	
            </tbody>
          </table>
          <button type="button" onclick="load_form_in_modal(<?php echo $school->schoolId; ?>, 'Edit Physical Facilities', 'School/physical_facilities_view_edit');" class="btn btn-flat btn-sm btn-primary no-print"><i class="fa fa-pencil"></i> Edit Physical Facilities
          </button>
        </div>
        <!-- /.col -->
      </div>
      ...
      <!-- Table row -->
      <div class="row page_break_before">
      	<h3 class="lead text-center">Section-C: Class & Age Wise Enrollement</h3>
        <div class="col-xs-12 table-responsive">
          <table class="table table-bordered">
            <thead>
            <tr>
            ...
            <?php if(!empty($school_staff)): ?>
              <?php foreach($school_staff as $st): ?>
                <tr id="staff_row_<?php echo $st->schoolStaffId; ?>">
                  ...
                  <td class="no-print" style="width: 250px;"><a href="javascript:void(0);" onclick="load_form_in_modal(<?php echo $st->schoolStaffId; ?>, 'Staff Update', 'School/school_staff_edit_by_id')"> &nbsp;<i class="fa fa-edit"></i></a>
        	 ...
        	 <?php endforeach; ?>
          <?php else:?>
            <td colspan="15" id="empty_td_staff"><h3 class="text-center text-danger">No Staff Added Yet.</h3></td>
          <?php endif;?>
            </tbody>
          </table>
          <button type="button" onclick="load_form_in_modal(<?php echo $school->schoolId; ?>, 'Add New Staff Member To School', 'School/school_staff_add_ajax');" class="btn btn-flat btn-sm btn-primary no-print"><i class="fa fa-user"></i> Add Staff
          </button>
        </div>
        <!-- /.col -->
      </div>
      ...
      <!-- Table row -->
      <div class="row page_break_before">
      	<h3 class="lead text-center">Section-E: Student Dues/Funds Details</h3>
        <div class="col-xs-12 table-responsive">
          <table class="table table-bordered table-condensed">
            <thead class="small_font">
            <tr>
            ...
            <tr>
              ...
              <td><?php echo $fe->addmissionFee; ?></td>
        	...
        	<tr>
        		<td>&nbsp;</td>
        	  <td colspan="3" class="text-center"><i>Whether the above fees are mentioned in the prospectus/admission form</i></td>
        	  
        	  <td colspan="2" class="text-center"><strong><?php echo $school_fee_mentioned_in_form->feeMentionedInForm; ?></strong></td>
        	</tr>
            </tbody>
          </table>
        </div>
      ...
      <!-- Table row -->
      <div class="row page_break_before">
      	<h3 class="lead text-center">Section-F: SECURITY MEASURES</h3>
        <div class="col-xs-10 col-xs-offset-1 table-responsive">
          ...
          <button type="button" onclick="load_form_in_modal(<?php echo $school->schoolId; ?>, 'Edit Security Measures', 'School/security_measures_edit_view_ajax_modal');" class="btn btn-flat btn-sm btn-primary no-print"><i class="fa fa-user"></i> Edit Security Measure
          </button>
        </div>
        <!-- /.col -->
      </div>
      ...
      <!-- Table row -->
      <div class="row page_break_before">
      	<h3 class="lead text-center">Section-G: HAZARDS WITH ASSOCIATED RISKS</h3>
        <div class="col-xs-10 col-xs-offset-1 table-responsive">
          <table class="table table-bordered">
            <tbody>
            <tr>
          ...
          <button type="button" onclick="load_form_in_modal(<?php echo $school->schoolId; ?>, 'Edit Hazards With Associated Risks', 'School/hazard_risk_edit_view_ajax_modal');" class="btn btn-flat btn-sm btn-primary no-print"><i class="fa fa-edit"></i> Edit Hazards With Associated Risks
          </button>
        </div>
        <!-- /.col -->
      </div>
      ...
      <!-- Table row -->
      <div class="row page_break_before">
      	<h3 class="lead text-center">Section-H: Fee Concession</h3>
        <div class="col-xs-10 col-xs-offset-1 table-responsive">
          <table class="table table-bordered table-condensed">
            <thead class="small_font">
            <tr>
    ...
    <div class="modal-dialog modal-lg">
      ...
      <script type="text/javascript">      
        ...
        function delete_record_by_id(id, column, table, prefix_id_text) {
          ...
          function get_last_inserted_row(id, url, prefix_id_text) {
