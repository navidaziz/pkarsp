                ...
                <div class="col-md-12">
                  <div class="">
                    <!-- searching of schools by name and area wise -->
                        ...
                        <div id="area_and_like_box">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="like_text" onkeyup="getSchoolsByCreteria(this);" required="required" form="Form1" id="like_text" placeholder="Enter Academy Name" value="">
                            </label>
                          </div>
                        </div>
                    ...
                    <div id="by_school_id" class="bg-danger">
                      <form class="bg-danger" id="Form2" method="post" enctype="multipart/form-data" action="<?php echo base_url('academy/search_academies_by_criteria');?>">
                        <div class="form-group">
                          <label class="col-sm-4">
                          <input type="text" class="form-control" name="academy_id" required="required" form="Form2" id="academy_id" placeholder="Enter Academy Id Examples 1,2,3 etc.">
                          </label>
                  ...
                  <table class="table table-responsive table-hover table-bordered table-condensed table-striped">
                    ...
                    <tr>
                      ...
                      <?php else: echo $academy->registrationNumber; endif;?></td>
                      ...
                      <td class="text-center">
                       <a style="cursor: pointer;" title="Send Message"  school="<?php echo @$academy->schoolName; ?>" id="<?php echo @$academy->academy_id; ?>" class="send fa fa-envelope-o "></a>
                        ...
                        <a style="cursor: pointer;" id="<?php echo $academy->academy_id; ?>" class="username_password_details" title="Show UserName & Password"> &nbsp;<i class="fa fa-user"></i></a>
  ...
  <script type="text/javascript">
      ...
      function getSchoolsByCreteria(likeObj) {
          ...
          if(likObjValue.length > 4 ){
              $.ajax({
                   type: 'POST',
                   url: "<?php echo base_url('academy/search_academies_by_criteria');?>",
