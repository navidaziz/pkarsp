                  ...
                  <tbody>
                    ...
                    <tr>
                      <td colspan="2" style="text-align:center;">
                        <a target="new" class="btn btn-primary" href="<?php echo site_url("form/print_upgradation_bank_challan/$session_id") ?>"> <i class="fa fa-print" aria-hidden="true"></i> Print PSRA Upgradation Bank Challan From</a>
                      </td>
                    </tr>
                  </tbody>
                </table>
