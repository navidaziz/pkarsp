                  ...
                  <tbody>
                    ...
                    <tr>
                      <td colspan="2" style="text-align:center;">
                        ...
                        <a target="new" class="btn btn-warning" href="<?php echo site_url("form/print_renewal_upgradation_bank_challan/$school_id") ?>"> <i class="fa fa-print" aria-hidden="true"></i> Print PSRA Upgradation + Renewal Bank Challan From</a>


                        <a target="_blank" class="btn btn-warning" href="<?php echo site_url('print_file/upgradation_security_slip/' . $schools_id) ?>">
                          <i class="fa fa-print"></i> Upgradation Security Challan</a>
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div style="border:1px solid #9FC8E8; border-radius: 10px; min-height: 100px;  margin: 5px; padding: 5px; background-color: white;">
              ...
              <ol>
                ...
                <li>As per PSRA Registration and Renewal Fee Structure, Institute charging monthly fee between
                  ...
                  <i>
                    <strong>Security requires for up gradation </strong>
                    <ul>
                      <li>Upgrading from <strong>Primary to Middle or High level</strong> requires security fee of Rs. <strong>5,000</strong>.</li>
                      <li>Upgrading from <strong>Primary to Higher Secondary level</strong> requires security fee of Rs. <strong>15,000</strong>. </li>
                      <li>Upgrading from <strong>Middle or High level to Higher Secondary level</strong> requires security fee of Rs. <strong>10,000</strong>.</li>
                    </ul>
                  </i>
