              ...
              <div style="border:1px solid #9FC8E8; border-radius: 10px; min-height: 100px;  margin: 5px; padding: 5px; background-color: white;">
                ...
                <table class="table" style="font-size: 13px;">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td> <strong>Security Fee(<?php echo $level_securities->levelofInstituteTitle; ?>) </strong> </td>
                      <td><strong>
                    ...
                    <tr>
                      <td><strong>2018-19 Special Fine (<?php echo $level_securities->levelofInstituteTitle; ?>)</strong></td>
                      <td>
                        <strong>
                          <?php
                          //echo $school->district_id . " - ";
                          $specialfine = $special_fine;
                          echo number_format($special_fine); ?>
                        </strong>
                      </td>
