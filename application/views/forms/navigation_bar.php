        ...
        <div class="col-md-12">
            ...
            <ul class="nav nav-pills nav-justified steps">
                ...
                <li <?php if ($this->uri->segment(2) == 'section_c') { ?> class="active" <?php  } ?> style="text-align: center;">
                    <a data-toggle="tooltip" data-placement="top" title="Please Complete Section B." href="<?php if ($form_status->form_b_status == 1) { ?> <?php echo site_url("form/section_c/$school_id"); ?> <?php } else { ?> # <?php } ?>"><?php if ($form_status->form_c_status == 1) { ?> <i class="fa fa-check" aria-hidden="true"></i> <?php } else { ?> <i class="fa fa-spinner" aria-hidden="true"></i> <?php } ?> SECTION C</a>
                ...
                <li <?php if ($this->uri->segment(2) == 'section_g') { ?> class="active" <?php  } ?> style="text-align: center;">
                    <a href="<?php if ($form_status->form_f_status == 1) { ?> <?php echo site_url("form/section_g/$school_id"); ?> <?php } else { ?> # <?php } ?>" data-toggle="tooltip" data-placement="top" title="Please Complete Section F.">
                ...
                <li <?php if ($this->uri->segment(2) == 'section_h') { ?> class="active" <?php  } ?> style="text-align: center;">
                    <a href="<?php if ($form_status->form_g_status == 1) { ?> <?php echo site_url("form/section_h/$school_id"); ?> <?php } else { ?> # <?php } ?>" data-toggle="tooltip" data-placement="top" title="Please Complete Section F.">
