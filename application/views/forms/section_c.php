        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-9">
              <table class="table table-bordered">
                <tr style="text-align: center; background-color: #8CAE12;">
                  <th rowspan="2" style="text-align: center; vertical-align: middle; background-color: #CE1A66; color:white">Total School Enrolment<br />
                    Session: <?php echo $session_detail->sessionYearTitle; ?></th>
                  <th colspan="19" style="text-align: center; background-color: #CE1A66; color:white">Age Categories</th>
                  <th colspan="3" style="background-color: #CE1A66; color:white"></th>
                </tr>
                <tr>
                  <?php
                  $count = 1;
                  foreach ($ages  as $age) { ?>
                    <th style="text-align: center; background-color: #CE1A66; color:white"><?php echo $age->ageTitle; ?></th>
                  <?php } ?>
                  <th style="background-color: #CE1A66; color:white; text-align: center;">Total</th>
                  <th style="background-color: #CE1A66; color:white; text-align:center;">Non-Muslims</th>
                  <th style="background-color: #CE1A66; color:white; text-align: center;">Disabled</th>

                </tr>
                <tr>
                  <th style="text-align: right; text-align: center;">Total No. of Boys</th>
                  <?php
                ...
                <tr>
                  <th style="text-align: center; background-color: #FFC0CB;">Total No. of Girls</th>
                  <?php
                  $total_school_entrollment  = 0;
                  foreach ($ages  as $age) { ?>
            ...
            <div class="col-md-12" style="text-align: center;">
              <a href="" class="btn btn-warning"><?php echo @ucfirst($title); ?> Session: <?php echo $session_detail->sessionYearTitle; ?> with this data</a>
            </div>
          </div>
        </div>
            ...
            <table class="table table-bordered">
              ...
              foreach ($classes  as $class) { ?>
                <tr>
                  ...
                  foreach ($ages  as $age) { ?>
                    <td style="text-align: center; background-color: bcd9ef;"><?php $query = "SELECT `enrolled` FROM `age_and_class` 
                                            WHERE age_id ='" . $age->ageId . "' 
                  ...
                  <td style="text-align: center;">
                    <?php if ($total_class_enrollment) { ?>
                      <button type="button" class="btn btn-success btn-sm" style="padding: 1px !important; width: 100%;" onclick="update_class_ages_from(<?php echo $schools_id ?>, 1, <?php echo $class->classId ?>)">
                        Edit
                      </button>

                    <?php  } else { ?>
                      <button type="button" class="btn btn-danger btn-sm" style="padding: 1px !important; width: 100%;" onclick="update_class_ages_from(<?php echo $schools_id ?>, 1, <?php echo $class->classId ?>)">
                        Add
                      </button>
                    <?php } ?>
                  </td>
            ...
            <table class="table table-bordered">
              ...
              foreach ($classes  as $class) { ?>
                <tr>
                  ...
                  <td style="text-align: center;">
                    <?php if ($total_class_enrollment) { ?>
                      <button type="button" class="btn btn-success btn-sm" style="padding: 1px !important; width: 100%;" onclick="update_class_ages_from(<?php echo $schools_id ?>, 2, <?php echo $class->classId ?>)">
                        Edit
                      </button>

                    <?php  } else { ?>
                      <button type="button" class="btn btn-danger btn-sm" style="padding: 1px !important; width: 100%;" onclick="update_class_ages_from(<?php echo $schools_id ?>, 2, <?php echo $class->classId ?>)">
                        Add
                      </button>
                    <?php } ?>
                  </td>
