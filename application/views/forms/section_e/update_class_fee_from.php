...
<div class="modal-body">
  ...
  <h5 style="color: red;">Note: Fee field is mandatory. pleas enter only numeric values only. eg. 500, 100, 0 etc</h5>
  <form action="<?php echo site_url("form/update_class_fee") ?>" method="post">
    <table class="table table-bordered">
      ...
      <tr>
        <th>Maximum Fee In Class <?php echo $class->classTitle ?></th>
