    ...
    <div class="block_div" style="margin-bottom: 35px;">
        <div class="row">
            ...
            <div class="col-xs-4" style="text-align: center;">
                <a class="btn btn-small" href='<?php echo site_url("visits/institute_visit_report/$visit_id/$schools_id/$school_id/a"); ?>'><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a>
            </div>

            <div class="col-xs-4" style="text-align: center;">
                <button class="btn btn-small" type="submit" name="submitButton" value="same">Save F-B</button>
            </div>
                ...
                if (response == 'success') {
                    switch (submitButtonValue) {
                        case "same":
                            ...
                            break;
                        case "next":
                            window.location.href = "<?php echo site_url("visits/institute_visit_report/$visit_id/$schools_id/$school_id/c"); ?>";
                            break;
                        default:
