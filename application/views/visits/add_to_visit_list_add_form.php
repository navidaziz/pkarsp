...
<?php
$query = "SELECT ss.schoolId, sy.sessionYearTitle FROM school as ss
INNER JOIN session_year as sy ON(sy.sessionYearId = ss.session_year_id)
WHERE ss.schools_id = '" . $school->schoolId . "' ORDER by schoolId DESC LIMIT 1";
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
                ...
                ?>
                    ...
                    <input required type="radio" id="<?php echo $option->schoolId; ?>" name="school_id" value="<?php echo $option->schoolId; ?>" class="">
                    <span style="margin-left:3px"></span> <?php echo $option->sessionYearTitle;  ?>
                <?php } ?>
            </div>
        </div>
        <div class="form-group row">
