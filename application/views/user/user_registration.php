...
<script>
  ...
  <body id="fade">
    ...
    <?php } ?>
    <div class="container" style="margin-bottom:100px;box-shadow: 0 3px 10px #aaa;
      -webkit-box-shadow: 0 3px 10px #aaa;
      -moz-box-shadow: 0 3px 10px #aaa;padding-top:20px;background-color: #dfeffc;">
      ...
      <section style="background-color: #dfeffc;">
        ...
        <div class="text-center row" style="margin:0 auto;width:100%;">
          <span style="color: red;line-height: 1px;text-align: center;">Note:Remember User Name and Password For Login To Your School acount.</span>
        </div>
        ...
        <div class="row">
          ...
          <div class="section   col-sm-12">
            ...
            <div class="panel_div"><b><i class="fa fa-user"></i> School Owner Information</b></div>
            <form method="post" enctype="multipart/form-data" action="<?php echo base_url('registration/create_school_user_process');?>" id="create_school_user_process">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <div class="form-group col-sm-12">
                    ...
                    <label for="userName" class="col-sm-2 control-label"><span class="text-danger">*</span>User-name</label>
                    <div class="col-sm-4">
                      <input length="5" type="text" onkeyup="check_username();"  required="required" class="form-control" name="userName" value="<?php echo set_value('userName');?>" id="username" placeholder="User-name">
            ...
            <div class="section   col-sm-12">
              <div class="panel_div"><b><i class="fa fa-home"></i> School Informaton</b></div>
              ...
              <div class="form-group col-sm-12">
                <strong class="col-sm-2">Registration Type:</strong>
              </div>
              <div class="form-group col-sm-12">
                <?php $reg_break = 0;?>
                <?php foreach ($reg_type as $reg) : ?>
                
                <label class=" col-sm-3" style="font-weight: 400;">
                  <input  type="radio" name="reg_type_id" form="create_school_user_process" class="reg_type_id flat-red" value="<?php echo $reg->regTypeId; ?>" <?php echo ($reg->regTypeId==1)?"checked":"" ?>> <?php echo $reg->regTypeTitle; ?>
                </label>
                <?php $reg_break++; ?>
                <?php endforeach; ?>
                <div id="reg_type_id"> </div><br>
              </div>
              <?php else: ?>
              ...
              <div class="form-group col-sm-12">
                ...
                <div class="col-sm-4">
                  <input length="5" value="<?php echo set_value('schoolName');?>" type="text" class="form-control" id="schoolName" required placeholder="Enter School Name" name="schoolName">
                </div>
                <label class="col-sm-2 control-label"><span class="text-danger">*</span>Session Year</label>
                <div class="col-sm-4">
                  <?php if(!empty($session_years)): ?>
                  <select class="form-control" name="session_year_id" style="width: 100%;">
              ...
              <div class="form-group col-sm-12">
                ...
                <div class="col-sm-4">
                  <input length="4" type="number" min="1900" max="2099" step="1" placeholder="Select Year of Establishment" value="<?php echo date('Y');?>" name="yearOfEstiblishment" <?php set_value('yearOfEstiblishment'); ?>  class="form-control" id="yoe" />
                </div>
              ...
              <div class="form-group col-sm-12">
                ...
                <div class="col-sm-4">
                  <input length="5" type="text" value="<?php set_value('postal_address'); ?>"   placeholder="Enter School Postal Address"  name="postal_address" class="form-control" id="postal_address" />
                </div>
              </div>
              <div class="form-group col-sm-12">
              ...
              <div class="form-group col-sm-12">
                ...
                <div class="col-sm-4">
                  <select required="required" class="form-control" required id="level_of_school" name="level_of_school_id" class="form-control" style="width: 100%;">
                    <option value="">Select</option>
              ...
              <div class="form-group col-sm-12">
                ...
                <div class="col-sm-4">
                  <select required="required" class="form-control" id="school_type_id" onchange="schoolTypeChanged(this);" required name="school_type_id" style="width: 100%;">
              ...
              <div  class="bottom form-group col-sm-12">
                ...
                <div class=" col-sm-12">
                  <input type="submit" name="submit" value="Create Acount" style="
                  border-radius: 12px;
    ...
    /////////////////////////////////
    function check_username(lab=true)
    {
    ...
    type: 'POST',
    async: !1,
    url: '<?php echo base_url('aJax/check_if_username_exist');?>',
    data:'username=' + username,   // I WANT TO ADD EXTRA DATA + SERIALIZE DATA
    success: function(data){
    //obj = $.parseJSON(data);
    console.log(data);
    if(data==1){
    //$('#check_username').parent().children('.errors').remove();
    
    $('#username').after('<span class="errors">Already exist Please try another one</span>');
    lab=false;
    //alert(lab);
    }
    else if(data==0){
    ...
    $('#username').after('<span class="text-success">User Name is available</span>');
    ...
    return false;
    ////////////////////////////
    if ($('input[name=reg_type_id]:checked').length <= 0) {
    $('#reg_type_id').after('<span class="error">Registration Type is required</span>');
    isvalid=false;
    }
