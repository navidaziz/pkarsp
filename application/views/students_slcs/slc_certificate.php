...
<body style="margin: 0px auto !important">
  <page size='A4'>
    <div style="padding: 5px; padding-top:20px;  padding-left:20px; padding-right:20px; " con tenteditable="true">
      <table class="" style="width:100%">
        ...
        <tr>
          <td>File No: <?php echo $student_slc->slc_file_no; ?> </td>
          <td> </td>
          <td style="text-align: right;">Certificate No: <?php echo $student_slc->slc_certificate_no; ?> </td>
        </tr>
        ...
        <tr>
          <td colspan="3">
            ...
            <p style="font-size: 16px; padding-left: 20px; padding-right: 20px;">It is certified that
              <span style="text-decoration: underline; font-weight: bold;">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <i><?php echo ucwords(strtolower($student_slc->student_name)) ?></i>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              </span>&nbsp; <?php if ($student_slc->gender == 'Male') {
                              echo "S/O ";
                            } else {
                              echo "D/O ";
                            } ?> <span style="text-decoration: underline; font-weight: bold;">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <i><?php echo ucwords(strtolower($student_slc->father_name)) ?></i>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              ...
              <span style="font-weight: bold;">
                ...
                of <?php echo date("F", strtotime($student_slc->student_data_of_birth)); ?>,
                <?php echo ucwords(convertNumberToWord(date("Y", strtotime($student_slc->student_data_of_birth)))); ?>
              </span>
              ).
            </p>
            <p style="font-size: 16px; padding-left: 20px; padding-right: 20px;">Admission No.
              ...
              <strong>
                <span style="text-decoration: underline; font-weight: bold;">
                  <?php echo date("d F, Y", strtotime($student_slc->admission_date)) ?>
                </span></strong>
              <br />
              Studying Class
              <span style="text-decoration: underline; font-weight: bold;">
            ...
            <p style="font-size: 16px; padding-left: 20px; padding-right: 20px;">Character and Conduct
              ...
              <strong>
                <span style="text-decoration: underline; font-weight: bold;">
                  <?php echo $student_slc->academic_record; ?>
                </span></strong>
              <br />
