  ...
  <?php if($request->deficient==0  or 1==1){ ?>
      <tr <?php if($request->deficient>0){ ?> style="color:red; <?php if($list_type==1){ ?> display:none;<?php } ?> "<?php } ?>">
        ...
        <?php if ($previous_school_id != $request->schools_id) { ?>
          <td><?php echo $count++; ?> <?php //echo $list_type; ?>
          <?php
          ...
          if( $once_deficient>0){
              echo '<i class="fa fa-flag" style="color:red" aria-hidden="true"></i>';
          }
          ?>
          </td>
        ...
        <td>
          ...
          if( $comments>0){
              echo '<i class="fa fa-comment" style="color:green" aria-hidden="true"></i>';
          }
          ?>
          </td>
