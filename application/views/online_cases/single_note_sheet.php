      ...
      <section class="invoice" style="margin-left: 10px; margin-right: 10px;">
        ...
        <div class="col-md-12">
          ...
          <ol class="notesheet_para">
              ...
              <strong><?php echo $school_sessions->levelofInstituteTitle; ?> Level (<?php if($school_sessions->gender_type_id==1){ echo "Boys"; } ?> <?php if($school_sessions->gender_type_id==2){ echo "Boys"; } ?><?php if($school_sessions->gender_type_id==3){ echo "Co Education"; } ?>)</strong> 
             ...
             <li><p>The school has been registered with the Board with registration number. <strong><?php echo $school_sessions->biseregistrationNumber;  ?></strong> <strong><?php echo $school_sessions->biseregistrationNumber;  ?></strong></p></li>
              <?php }else{ ?>
              <li><p>School is not registered with any Board.</p></li>
              <?php } ?>
