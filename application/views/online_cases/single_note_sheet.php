        ...
        <div class="col-md-12">
          <table class="table2" style="width: 100%;">
            <tr>
              ...
              <td>
                <div>
                  <img style="border-radius: 5px; border: 1px solid black;" src="https://api.qrserver.com/v1/create-qr-code/?color=000000&amp;bgcolor=FFFFFF&amp;data=https%3A%2F%2Fpsra.gkp.pk%2Finstitute%2Fqrcode%2F<?php echo $schools_id; ?>%2F<?php echo $school_id; ?>&amp;qzone=1&amp;margin=0&amp;size=108x108&amp;ecc=L" alt="qr code" />
                </div>
              </td>
            </tr>
          </table>
