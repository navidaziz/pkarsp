  ...
  <page size='A4'>
    <div style="padding: 10px;" style="width: 100%;">
      ...
      <div style="margin: 10px;">
        ...
        <?php //var_dump($deficiency_detail); 
        ?>
        <table class="table table-bordered">
          ...
          <tbody>
            <tr>
              ...
              <td><?php echo number_format($deficiency_detail->application_processing_fee); ?> Rs.</td>
            </tr>
            <tr>
              <td>Inspection Fee</td>
              <td><?php echo number_format($deficiency_detail->inspection_fee); ?> Rs.</td>
            </tr>
            <tr>
              <td>Renewal Fee</td>
              <td><?php echo number_format($deficiency_detail->renewal_fee); ?> Rs.</td>
            </tr>
            <tr>
              <td>Late Fee</td>
              <td><?php echo number_format($deficiency_detail->late_fee); ?> Rs.</td>
            </tr>
            <tr>
              <td>Security Fee</td>
              <td><?php echo number_format($deficiency_detail->security_fee); ?> Rs.</td>
            </tr>
            ...
            <tr>
              ...
              <td><?php echo number_format($deficiency_detail->upgradation_fee); ?> Rs.</td>
            </tr>
            <tr>
              <td>Renewl & Upgradation Fee</td>
              <td><?php echo number_format($deficiency_detail->renewal_and_upgradation_fee); ?> Rs.</td>
            </tr>

            <tr>
              <td>Fine</td>
              <td><?php echo number_format($deficiency_detail->fine); ?> Rs.</td>
            </tr>
            <tr>
              <td colspan="2" style="text-align: right;">Total: <?php echo number_format($deficiency_detail->total_deposit_fee); ?> Rs.</td>
            </tr>
