...
<body <?php if ($schools_info->isRejected == 0) { ?> onload="window.print();" <?php } ?> style="line-height: 20px;">
  <div class="wrapper">
    <?php if ($schools_info->isRejected == 0) { ?>
            ...
            <table class="table table-condensed table-bordered">
              ...
              <tbody>
                <tr>
                  ...
                  <td><?php echo @$schools_info->school_id; ?></td>
                  <td><?php echo @$schools_info->registrationNumber; ?></td>
                  <td><?php echo @$schools_info->biseregistrationNumber; ?></td>
                  <?php  ?>
                  <?php if ($schools_info->old_new == 0) { ?>
                    <td> <?php echo @$lower_class->classTitle . " To " . @$schools_info->upper_class; ?> </td>
                  <?php } ?>

                  <?php if ($schools_info->old_new == 1) {
                    $levels = "";
                  ?>
                    <td>
                      <?php if ($schools_info->primary_level == 1) {
                        $levels .= " Primary, ";
                      } ?>
                      <?php if ($schools_info->middle_level == 1) {
                        $levels .= " Middle, ";
                      } ?>

                      <?php if ($schools_info->high_level == 1) {
                        $levels .= " High, ";
                      } ?>

                      <?php if ($schools_info->h_sec_college_level == 1) {
                        $levels .= " High Secondary / College,";
                      }
                      echo rtrim($levels, ", ");
                      ?>
                    </td>
    ...
    <?php } else {
      echo '<p style="text-align:center; margin-top:30px">Session application is rejected or removed.</p>';
    } ?>
  </div>
  <!-- ./wrapper -->
</body>
