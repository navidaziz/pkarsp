                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <p>All private institutions in Khyber Pakhtunkhwa are directed to submit a compliance report on publisher text books being taught at each level for the current session.</p>
                        ...
                        foreach ($levels as $key => $level) { ?>
                          ...
                          <div class="form-group">
                            <label for="<?php echo $level->levelofInstituteTitle; ?>">Level: <?php echo $level->levelofInstituteTitle; ?></label>
                            Publisher: <select class="form-control" required name="level[<?php echo $level->levelofinstitute; ?>]">
                              <?php
                              $query = "SELECT * FROM `publishers`";
                              $publishers = $this->db->query($query)->result();
                              foreach ($publishers as $publisher) { ?>
                                <option <?php echo $publisher->id; ?>><?php echo $publisher->publisher_name; ?></option>
                              <?php } ?>
                            </select>
