            ...
            <div style="border:1px solid #9FC8E8; border-radius: 10px; min-height: 2px;  margin: 5px; padding: 5px; background-color: white;">
              ...
              if ($school->registrationNumber) { ?>
                ...
                <table class="table table-bordered">
                  ...
                  $reg_detail =   $this->db->query($query)->result()[0];
                              ...
                              <?php if ($upgradation_and_renewal->status == 1) { ?>
                                <a target="_new" href="<?php echo site_url("school_dashboard/certificate/" . $upgradation_and_renewal->schools_id . "/" . $upgradation_and_renewal->school_id . "/" . $upgradation_and_renewal->session_year_id); ?>">Print Certificate<a>
                                  <?php } else { ?>
                                    ...
                                    <a class="btn btn-success" href="<?php echo site_url("online_application/status/$upgradation_and_renewal->school_id"); ?>"> <i class="fa fa-spinner" aria-hidden="true"></i> Check Application Status</a>
                    ...
                    <tr>
                      ...
                      <td>
                        <?php if ($renewal->status == 0) {
                          ...
                          $query = "SELECT * FROM `forms_process` WHERE  `forms_process`.`school_id` = $renewal->school_id";
                        ...
                        ?>
                          <a class="btn btn-success" href="<?php echo site_url("form/$page_link/$renewal->school_id"); ?>"> <i class="fa fa-spinner" aria-hidden="true"></i> Complete Renewal Process</a>
                        <?php } else {   ?>
                          <?php if ($renewal->status == 1) { ?>
                            <a target="_new" href="<?php echo site_url("school_dashboard/certificate/" . $renewal->schools_id . "/" . $renewal->school_id . "/" . $renewal->session_year_id); ?>">Print Certificate<a>
                              ...
                              ?>
                                ...
                                <strong>
                                  <?php echo get_session_request_status($renewal->status); ?>
                                </strong><br />
                                <a class="btn btn-success" href="<?php echo site_url("online_application/status/$renewal->school_id"); ?>"> <i class="fa fa-spinner" aria-hidden="true"></i> Check Application Status</a>
                        ...
                        <?php } else {   ?>
                          <?php if ($upgradation->status == 1) { ?>
                            <a target="_new" href="<?php echo site_url("school_dashboard/certificate/" . $upgradation->schools_id . "/" . $upgradation->school_id . "/" . $upgradation->session_year_id); ?>">Print Certificate<a>
                              <?php } else { ?>
                                <a class="btn btn-success" href="<?php echo site_url("online_application/status/$upgradation->school_id"); ?>"> <i class="fa fa-spinner" aria-hidden="true"></i> Check Application Status</a>
