...
(SELECT SUM(w.waived_off_amount) FROM fine_waived_off as w WHERE w.is_deleted=0  ) as total_waived_off,
(SELECT SUM(fp.deposit_amount) FROM fine_payments as fp WHERE fp.is_deleted=0  ) as total_fine_paid
FROM fines as f
