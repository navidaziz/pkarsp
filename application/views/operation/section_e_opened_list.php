    ...
    <tbody>
      ...
      if ($search_list) {
        ...
        ";
            ...
            <td>
              <a href="<?php echo site_url("operation/section_e/" . $school->schools_id . "/" . $school->school_id . "/" . $school->session_id) ?>">Update</a>
              <span style="margin-left: 10px;"></span>
              <a target="_blank" href="<?php echo site_url("print_file/section_e/" . $school->school_id) ?>"">Print</a>
            </td>
