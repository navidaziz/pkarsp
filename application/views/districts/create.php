        ...
        <div class="box-body">
          <div class="row">
                <div class="col-md-offset-1 col-md-9">
                  <form class="form-horizontal" method="post" enctype="multipart/form-data" id="role_form" action="<?php echo base_url('district/create_process');?>">
                    ...
                    <div class="box-body">
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          ...
                          <input type="text" class="form-control" name="districtTitle" value="<?php echo set_value('districtTitle');?>" id="title" placeholder="<?php echo @ucfirst($title); ?> Title">
