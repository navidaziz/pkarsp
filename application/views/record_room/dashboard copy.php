...
<div class="content-wrapper">
    ...
    <div class="row">
        ...
        $query = "SELECT * FROM district GROUP BY region ASC";
        $regions = $this->db->query($query)->result();
        foreach ($regions as $region) { ?>
            <div class="col-lg-3 col-xs-3">
                <div class="small-box bg-yellow" style="padding-bottom: 10px;  ">
                    ...
                    <div style="padding: 5px; min-height:350px;">
                        <table class="table" style="text-align: center;">
                            <tr>
                                <th colspan="3"></th>
                                <th colspan="3" style="text-align: center;">Pending Cases</th>
                            </tr>
                            <tr>
                    ...
                    <div style="text-align: center;">
                        <button onclick="open_visit_modal()" class="btn btn-primary btn-sm">Add School In Visit List</button>
                    </div>
                </div>
