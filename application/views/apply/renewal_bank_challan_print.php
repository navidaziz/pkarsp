        ...
        <tr>
          ...
          <th>
            <h3 style="text-align: center;">Public School Regulatory Authority Khyber Pakhtunkhwa</h4>
              <h4 style="text-align: center;">Renewal Challan Form For Session <?php echo $session_detail->sessionYearTitle; ?>
              </h4>
        ...
        <table style="width: 100%;">
          <tr>
            ...
            <th>Receipt No: <span style="text-decoration: underline; ">
                <strong><?php echo $school_detail->schoolId + $school_detail->district_id; ?><strong></span></th>
          ...
          <table class="table">
            <tr>
              <td>Institute Name: <span style="text-decoration: underline; ">
                  <strong><?php echo $school_detail->schoolName; ?><strong></span></td>
              <td colspan="2">District: <span style="text-decoration: underline; ">
                  <strong><?php $query = "SELECT `districtTitle` FROM `district` WHERE districtId = '" . $school_detail->district_id . "'";
                          echo $this->db->query($query)->result()[0]->districtTitle; ?></td>
              <td colspan="4">Level of Institute: <span style="text-decoration: underline; ">
                  <strong><?php $query = "SELECT `levelofInstituteTitle` FROM `levelofinstitute` WHERE levelofInstituteId = '" . $school_detail->level_of_school_id . "'";
        ...
        <table class="table table-bordered" style="font-size: 15px;">
          ...
          <tbody>
            <tr>
              ...
              <td>Rs. <?php echo $fee_sturucture->renewal_app_processsing_fee; ?></td>
            </tr>
            <tr>
              <th>Inspection Fee</th>
              <td>Rs. <?php echo $fee_sturucture->renewal_app_inspection_fee; ?></td>
            </tr>
            <tr>
              <th>Renewal Fee</th>
              <td>Rs. <?php echo $fee_sturucture->renewal_fee; ?></td>
            </tr>
