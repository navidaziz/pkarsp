          ...
          <div class="row">
            ...
            <div class="col-md-9">
              ...
              <table class="table table2 table-bordered">
                ...
                <tr>
                  <th style="text-align: right; text-align: center;">Total No. of Boys Students</th>
                  <?php
                ...
                <tr>
                  <th style="text-align: center; background-color: #FFC0CB;">Total No. of Girls Students</th>
                  <?php
                  $total_school_entrollment  = 0;
                  foreach ($ages  as $age) { ?>
