  ...
  <script>
    function get_employee_edit_form(employee_id) {
      $.ajax({
        type: "POST",
        url: "<?php echo site_url("staff_statement/get_employee_edit_form"); ?>",
        data: {
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content" id="">
        ...
        <div class="modal-body">
          ...
          <form action="<?php echo site_url("staff_statement/add_employee_data"); ?>" method="post">
            ...
            <div class="col-md-7">
              <h4 style="border-left: 20px solid #9FC8E8; padding-left:5px"><strong><?php echo @$description; ?></strong><br />
                <small style="color: red; display:inline">
                  Please provide the details for the Principal, Vice Principal, Teaching Staff, and Non-Teaching Staff.
                </small>
                        ...
                        <tr id="staff_row_<?php echo $st->schoolStaffId; ?>">
                          ...
                          <td>
                            <?php if ($school->status != 1) { ?>
                              ...
                              <a href="<?php echo site_url("staff_statement/delete_employee/$st->schoolStaffId/$school_id/$session_id"); ?>" title="Delete Employee" onclick="return confirm('Are you sure? you want to remove the employee?')"> &nbsp;<i class="fa fa-trash-o text-danger"></i>
                              </a>
                            <?php } ?>
                          </td>
                        </tr>
